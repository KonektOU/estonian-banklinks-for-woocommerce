<div class="wc-gateway-estonia-banklink__maksekeskus">
	...
	<?php foreach( $methods as $key => $method ) : ?>
		<div class="banklink-maksekeskus-selection<?php if( $current_method == $method->name ) echo ' banklink-maksekeskus-selection--active' ?>" data-name="<?php echo esc_attr( $method->name ) ?>">
